...
import com.zh.zhpicturebackend.model.dto.picture.*;
import com.zh.zhpicturebackend.model.entity.Picture;
import com.zh.zhpicturebackend.model.entity.User;
import com.zh.zhpicturebackend.model.enums.PictureReviewStatusEnum;
...
//    @AutoCheck(mustRole = UserConstant.ADMIN_ROLE)
    @PostMapping("/upload")
    public BaseResponse<PictureVO> pictureUploadFileByUrl(@RequestPart("file") MultipartFile multipartFile,
